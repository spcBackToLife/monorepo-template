...
| Phase F | 参考框系统 | 16-canvas-enhancement §F | ✅ 已完成 |
| Phase G | 智能对齐线 | 16-canvas-enhancement §G | ✅ 已完成 |
| Phase H | 对齐与分布 | 16-canvas-enhancement §H | ✅ 已完成 |
| Phase I | 矢量布尔运算 | 16-canvas-enhancement §I | ✅ 已完成 |
| Phase J | 路径高级操作 | 16-canvas-enhancement §J | ✅ 已完成 |
| Phase K | 素材工程持久化（DB + 文件存储） | 素材可编辑 + 导出上传 | ✅ 已完成 |
...
| F.1 | 参考框系统（ReferenceFrame.ts） | ✅ 已完成 | 2026-04-07 |
| F.2 | 参考框集成到 MaterialEditorCore | ✅ 已完成 | 2026-04-07 |
| F.3 | 参考框外区域棋盘格遮罩（CanvasGrid 增强） | ✅ 已完成 | 2026-04-07 |
| F.4 | 导出裁切到参考框（ExportBar 增强） | ✅ 已完成 | 2026-04-07 |
| G.1 | 智能对齐线引擎（SmartGuides.ts） | ✅ 已完成 | 2026-04-07 |
| G.2 | 智能对齐线 UI 开关 | ✅ 已完成 | 2026-04-07 |
| G.3 | 智能对齐线与网格吸附优先级处理 | ✅ 已完成 | 2026-04-07 |
| H.1 | 对齐与分布模块（AlignDistribute.ts） | ✅ 已完成 | 2026-04-07 |
| H.2 | 对齐/分布 UI 按钮组 + 参考框对齐 | ✅ 已完成 | 2026-04-07 |
| H.3 | 对齐快捷键（⌘Alt+方向键） | ✅ 已完成 | 2026-04-07 |
| I.1 | 矢量布尔运算（VectorBooleanOps.ts + paper.js） | ✅ 已完成 | 2026-04-07 |
| I.2 | 布尔运算 UI 按钮组（5 种运算） | ✅ 已完成 | 2026-04-07 |
| I.3 | 布尔运算快捷键（⌘⇧U/S/I/E） | ✅ 已完成 | 2026-04-07 |
| I.4 | 矢量→像素回退机制 | ✅ 已完成 | 2026-04-07 |
| J.1 | 路径高级操作（PathOperations.ts） | ✅ 已完成 | 2026-04-07 |
| J.2 | 工程文件 v2→v3 兼容迁移 | ✅ 已完成 | 2026-04-07 |
| K.1 | 数据库建表（material_design_projects） | ✅ 已完成 | 2026-04-07 |
| K.2 | 后端 Service 迁移到 PostgreSQL（从 JSON 文件） | ✅ 已完成 | 2026-04-07 |
| K.3 | 后端 Controller 升级（列表/详情/按节点查找/导出上传/缩略图） | ✅ 已完成 | 2026-04-07 |
| K.4 | 前端 API Client（materialProject.ts） | ✅ 已完成 | 2026-04-07 |
| K.5 | ExportBar 保存工程改为 API 持久化 | ✅ 已完成 | 2026-04-07 |
| K.6 | MaterialEditorModal 自动加载关联工程 | ✅ 已完成 | 2026-04-07 |
| K.7 | 导出素材通过 StorageProvider 上传（S3 扩展就绪） | ✅ 已完成 | 2026-04-07 |
